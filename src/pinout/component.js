(() => {
    class PinoutComponent extends HTMLElement {
        constructor() {
            super()
        ...
        // Returns if matched
        #setPinHighlight({ id, bgColor, highlightSuffix }) {
        ...
        #updateIoHighlight(io) {
            const bgColor = io.bgColor || "#bbbbbb"


            this.#setPinHighlight({
                id: io.id,
                bgColor: bgColor,
                highlightSuffix: ""
            })
            ...
            if (io.rolesAvailable) {
                ...
                const activeBgColor = io.bgColor || "#bbbbbb"
        ...
        setIos(ios) {
            ...
            for (const io of ios) {
                ...
                const name = io.label
                // const color = rolesColors[io.role]?.color || "#333333",

                const color = io.bgColor || "#333333"
    ...
    customElements.define('pinout-image', PinoutComponent);
